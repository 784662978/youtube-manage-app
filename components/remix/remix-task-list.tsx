...
export function RemixTaskList({ channels, onNotification, onCreateTask, onEditTask, onRefresh }: RemixTaskListProps) {
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <Select value={channel || "__all__"} onValueChange={(v) => { setChannel(v === "__all__" ? "" : v); setLanguage("") }}>
                        ...
                        <div className="flex items-center gap-1" onClick={(e) => e.stopPropagation()}>
                          {task.status === "completed" && task.result_oss && (
                            <Button variant="ghost" size="sm" className="h-7 px-2 text-xs" asChild>
                              <a href={task.result_oss} target="_blank" rel="noopener noreferrer">
